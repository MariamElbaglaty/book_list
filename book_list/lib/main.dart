import 'package:book_list/data_base.dart';
...

      {
        ...
        return CircularProgressIndicator();}
         ...
         return ListView.builder(
              ...
              {
                book book_mine = book.fromMap(snapshot.data[index]);
                 return Container(
                      height: 100,
                      width: 100,
                    child: ListTile(
        ...
        fontSize: 20,)
                        ...
                        subtitle: Text(book_mine.Author,
                  ...
                  TextFormField(
                           ...
                           onChanged: (value){
                              ...
                              RaisedButton(
                                ...
                                book  mine = book({'name':book_name,'author':book_author});
